...
<html lang="en">
    <head>
        ...
        <title><% out.print(Config.TITLE); %> - Edit Domain</title>
            ...
            <section>
                ...
                <div class="mainpanel">
                    ...
                    <div class="contentpanel">
                        ...
                        <form class="form-horizontal" action="Domain?action=edit_save" method="post">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select id="asset_id" required name="asset_id" data-placeholder="Choose One" class="width300">
                                                ...
                                                <option<%= (Int.get(data.get("asset_id")) == Int.get(asset.get("id")) ? " selected='selected'" : "") %> value="<%= asset.get("id") %>">@<%= asset.get("name") + " - " + asset.get("btc") + " BTC" %></option>
                                                <% } %>
                                            </select>
                                        </div>
                                    </div><!-- form-group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="text" required name="domain" value="<%= data.get("domain") %>" class="form-control" />
                                        </div>
                                    </div><!-- form-group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="privacy_protection" class="form-control" value="<%= data.get("privacy_protection") %>" />
                                        </div>
                                    </div><!-- form-group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="expire_date" class="form-control datepicker" value="<%= data.get("expire_date") %>" />
                                        </div>
                                    </div><!-- form-group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select id="auto_renewal" name="auto_renewal" data-placeholder="Choose One" class="width300">
                                                <option value="">Choose One</option>
                                                <option<%= (Int.get(data.get("auto_renewal")) == 1 ? " selected='selected'" : "") %> value="1">Yes</option>
                                                <option<%= (Int.get(data.get("auto_renewal")) == 0 ? " selected='selected'" : "") %> value="0">No</option>
                                            </select>
                                        </div>
                                    </div><!-- form-group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select id="transfer_lock" name="transfer_lock" data-placeholder="Choose One" class="width300">
                                                <option value="">Choose One</option>
                                                <option<%= (Int.get(data.get("transfer_lock")) == 1 ? " selected='selected'" : "") %> value="1">Yes</option>
                                                <option<%= (Int.get(data.get("transfer_lock")) == 0 ? " selected='selected'" : "") %> value="0">No</option>
                                            </select>
                                        </div>
                                    </div><!-- form-group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="price_per_month" class="form-control" value="<%= data.get("price_per_month") %>" />
                                        </div>
                                    </div><!-- form-group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="price_per_year" class="form-control" value="<%= data.get("price_per_year") %>" />
                                        </div>
                                    </div><!-- form-group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="price_forever" class="form-control" value="<%= data.get("price_forever") %>" />
                                        </div>
                                    </div><!-- form-group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select id="status" required name="status" data-placeholder="Choose One" class="width300">
                                                <option value="">Choose One</option>
                                                <option<%= (Int.get(data.get("status")) == 1 ? " selected='selected'" : "") %> value="1">Active</option>
                                                <option<%= (Int.get(data.get("status")) == 0 ? " selected='selected'" : "") %> value="0">Deactive</option>
                                            </select>
                                        </div>
                                    </div><!-- form-group -->
