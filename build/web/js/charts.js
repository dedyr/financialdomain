jQuery(document).ready(function() {
    ...
    var piedata = [
        ...
        { label: "Series 4", data: [[1,70]], color: '#FF9900'},
   ...
   var m1 = new Morris.Line({
    ...
    var m6 = new Morris.Donut({
        ...
        colors: ['#D9534F','#1CAF9A','#FF9900','#5BC0DE','#FF9900']
    });
    ...
    jQuery('#sparkline3').sparkline([4,3,3,1,4,3,2,2,3], {
		  type: 'pie', 
		  height:'33px',
        sliceColors: ['#F0AD4E','#FF9900','#D9534F','#1CAF9A','#5BC0DE']
    });
