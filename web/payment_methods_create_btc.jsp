...
<html lang="en">
    <head>
        ...
        <title><% out.print(Config.TITLE); %> - Add Bitcoin Address</title>
            ...
            <section>
                ...
                <div class="mainpanel">
                    ...
                    <div class="contentpanel">
                        ...
                        <form class="form-horizontal" action="PaymentMethods?action=create_btc_save" method="post">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" required name="btc_address" class="form-control" />
                                        </div>
                                    </div><!-- form-group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" required name="name_on_address" class="form-control" />
                                        </div>
                                    </div><!-- form-group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="current_ballance" class="form-control" />
                                        </div>
                                    </div><!-- form-group -->
